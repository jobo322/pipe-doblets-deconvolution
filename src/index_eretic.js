...
(async () => {
  ...
  // const path = '/nmr/IVDR02/data/covid19_heidelberg_URI_NMR_URINE_IVDR02_COVp96_181121';

  // const pathToWrite = '/home/centos/ereticQuant'; // for ANPC
  // const pathToWrite = '/home/centos/Heid'; // for Heid TimeCurve
...
function process(options) {
  ...
  const fromTo = { from: 11.97, to: 12.02 }; // Changed to the eretic region
  ...
  writeFileSync(join(pathToWrite, `${name}_eretic.json`), JSON.stringify([{
    name,
    expno: 'null',
    fit: [
      {
